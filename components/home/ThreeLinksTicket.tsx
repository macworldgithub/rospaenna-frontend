...
export default function ThreeLinksTicket() {
  return (
    <section className="bg-[#050505] py-10 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto border border-[#8B6A2A]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10 px-4 sm:px-10 py-8 sm:py-12">
          {/* Left Content */}
          <div className="max-w-2xl">
            ...
            <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-serif font-semibold leading-tight">
          ...
          <div className="w-full sm:w-auto shrink-0">
            <button
              ...
              className="w-full sm:w-auto bg-[#D9AE4D] hover:bg-[#c79d40] transition-all duration-300 text-black uppercase tracking-[0.3em] text-[11px] font-semibold px-6 sm:px-10 py-4 sm:py-5"
            >
